...
<html>
	<head>
		...
		<title>Ajouter Compte Utilisateur</title>
	...
	<body background="CRTV4.JPG">		
		...
		<div class="container user-page">
			<h1 class="text-center">
        		Compte Utilisateur - Formulaire de Création
    		</h1>
			<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">			
				...
				<input
						...
						type="submit"
						value="ENREGISTRER LE COMPTE">
				<input type="button" class="btn btn-warning" onclick="history.back();" value="ANNULER CREATION">
			</form>
